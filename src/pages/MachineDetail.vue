...
const mockData = {
    ...
    C001: { name: '調膠1', location: 'B棟1樓', category: '塗佈', status: 'running', communicationStatus: 'normal', points: [{ name: '溫度', value: '72.3°C', unit: '°C', status: 'normal' }] },
    C003: { name: '調膠2', location: 'B棟1樓', category: '塗佈', status: 'standby', communicationStatus: 'normal', points: [{ name: '溫度', value: '70.1°C', unit: '°C', status: 'normal' }] },
    C004: { name: '調膠3', location: 'B棟1樓', category: '塗佈', status: 'running', communicationStatus: 'normal', points: [{ name: '溫度', value: '73.5°C', unit: '°C', status: 'normal' }] },
    C005: { name: '調膠4', location: 'B棟1樓', category: '塗佈', status: 'standby', communicationStatus: 'normal', points: [{ name: '溫度', value: '68.9°C', unit: '°C', status: 'normal' }] },
    ...
    P001: { name: '熱切分條機 (E-17)', location: 'C棟1樓', category: '本業加工', status: 'running', communicationStatus: 'normal', points: [{ name: '米數', value: '1250 m', unit: 'm', status: 'normal' },{ name: '溫度', value: '185.0°C', unit: '°C', status: 'normal' },{ name: '張力', value: '22.8 N', unit: 'N', status: 'normal' },{ name: '轉速', value: '45 m/min', unit: 'm/min', status: 'normal' }] },
    ...
    CV001: { name: '分條機 (G-01)', location: 'D棟1樓', category: 'COVER加工', status: 'running', communicationStatus: 'normal', points: [{ name: '米數', value: '860 m', unit: 'm', status: 'normal' },{ name: '轉速', value: '60 m/min', unit: 'm/min', status: 'normal' },{ name: '張力', value: '18.5 N', unit: 'N', status: 'normal' }] },
    CV005: { name: '分條機 (G-02)', location: 'D棟1樓', category: 'COVER加工', status: 'standby', communicationStatus: 'normal', points: [{ name: '米數', value: '0 m', unit: 'm', status: 'normal' },{ name: '轉速', value: '0 m/min', unit: 'm/min', status: 'normal' },{ name: '張力', value: '0 N', unit: 'N', status: 'normal' }] },
    CV006: { name: '分條機 (G-03)', location: 'D棟1樓', category: 'COVER加工', status: 'running', communicationStatus: 'normal', points: [{ name: '米數', value: '742 m', unit: 'm', status: 'normal' },{ name: '轉速', value: '58 m/min', unit: 'm/min', status: 'normal' },{ name: '張力', value: '17.8 N', unit: 'N', status: 'normal' }] },
    CV002: { name: '貼合機1', location: 'D棟1樓', category: 'COVER加工', status: 'standby', communicationStatus: 'normal', points: [{ name: '米數', value: '0 m', unit: 'm', status: 'normal' },{ name: '轉速', value: '0 m/min', unit: 'm/min', status: 'normal' },{ name: '張力', value: '0 N', unit: 'N', status: 'normal' }] },
    CV007: { name: '貼合機2', location: 'D棟1樓', category: 'COVER加工', status: 'running', communicationStatus: 'normal', points: [{ name: '米數', value: '315 m', unit: 'm', status: 'normal' },{ name: '轉速', value: '15 m/min', unit: 'm/min', status: 'normal' },{ name: '張力', value: '12.3 N', unit: 'N', status: 'normal' }] },
    ...
    L002: { name: '薄膜複捲機', location: 'E棟1樓', category: '淋膜', status: 'standby', communicationStatus: 'normal', points: [] },
    F001: { name: '廠務設備', location: 'F棟地下室', category: '廠務', status: 'running', communicationStatus: 'normal', points: [{ name: 'DI/O接點', value: '正常', unit: '', status: 'normal' }] },
    F002: { name: '主鍋爐溫度', location: 'F棟1樓', category: '廠務', status: 'running', communicationStatus: 'normal', points: [{ name: '溫度1', value: '185.5°C', unit: '°C', status: 'normal' },{ name: '溫度2', value: '172.3°C', unit: '°C', status: 'normal' },{ name: '溫度3', value: '168.0°C', unit: '°C', status: 'normal' }] },
    ...
    AQ001: { name: '空氣品質1', location: 'F棟1樓', category: '廠務', status: 'running', communicationStatus: 'normal', points: [] },
    AQ002: { name: '空氣品質2', location: 'F棟2樓', category: '廠務', status: 'running', communicationStatus: 'normal', points: [] },
}
