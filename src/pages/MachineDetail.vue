...
const mockData = {
    ...
    C001: { name: '調膠1', location: 'B棟1樓', category: '塗佈', status: 'running', communicationStatus: 'normal', points: [{ name: '膠體溫度', value: '72.3°C', unit: '°C', status: 'normal' },{ name: '攪拌轉速', value: '860 rpm', unit: 'rpm', status: 'normal' },{ name: '黏度', value: '1420 cP', unit: 'cP', status: 'warning' },{ name: '液位', value: '68 %', unit: '%', status: 'normal' },{ name: '電流', value: '32.1 A', unit: 'A', status: 'normal' }] },
    C003: { name: '調膠2', location: 'B棟1樓', category: '塗佈', status: 'standby', communicationStatus: 'normal', points: [{ name: '膠體溫度', value: '70.1°C', unit: '°C', status: 'normal' },{ name: '攪拌轉速', value: '840 rpm', unit: 'rpm', status: 'normal' },{ name: '黏度', value: '1380 cP', unit: 'cP', status: 'normal' },{ name: '液位', value: '65 %', unit: '%', status: 'normal' },{ name: '電流', value: '30.5 A', unit: 'A', status: 'normal' }] },
    C004: { name: '調膠3', location: 'B棟1樓', category: '塗佈', status: 'running', communicationStatus: 'normal', points: [{ name: '膠體溫度', value: '73.5°C', unit: '°C', status: 'normal' },{ name: '攪拌轉速', value: '870 rpm', unit: 'rpm', status: 'normal' },{ name: '黏度', value: '1450 cP', unit: 'cP', status: 'normal' },{ name: '液位', value: '70 %', unit: '%', status: 'normal' },{ name: '電流', value: '33.4 A', unit: 'A', status: 'normal' }] },
    C005: { name: '調膠4', location: 'B棟1樓', category: '塗佈', status: 'standby', communicationStatus: 'normal', points: [{ name: '膠體溫度', value: '68.9°C', unit: '°C', status: 'normal' },{ name: '攪拌轉速', value: '820 rpm', unit: 'rpm', status: 'normal' },{ name: '黏度', value: '1360 cP', unit: 'cP', status: 'normal' },{ name: '液位', value: '62 %', unit: '%', status: 'normal' },{ name: '電流', value: '29.2 A', unit: 'A', status: 'normal' }] },
    C002: { name: '塗佈機1', location: 'B棟1樓', category: '塗佈', status: 'standby', communicationStatus: 'normal', points: [{ name: '塗佈溫度', value: '65.3°C', unit: '°C', status: 'normal' },{ name: '烘箱溫度', value: '120.5°C', unit: '°C', status: 'normal' },{ name: '張力', value: '15.2 N', unit: 'N', status: 'warning' },{ name: '速度', value: '80 m/min', unit: 'm/min', status: 'normal' },{ name: '塗佈厚度', value: '25.5 μm', unit: 'μm', status: 'normal' },{ name: '電流', value: '28.7 A', unit: 'A', status: 'normal' }] },
    C006: { name: '塗佈機2', location: 'B棟1樓', category: '塗佈', status: 'running', communicationStatus: 'normal', points: [{ name: '塗佈溫度', value: '67.1°C', unit: '°C', status: 'normal' },{ name: '烘箱溫度', value: '122.0°C', unit: '°C', status: 'normal' },{ name: '張力', value: '16.0 N', unit: 'N', status: 'normal' },{ name: '速度', value: '85 m/min', unit: 'm/min', status: 'normal' },{ name: '塗佈厚度', value: '26.0 μm', unit: 'μm', status: 'normal' },{ name: '電流', value: '29.5 A', unit: 'A', status: 'normal' }] },
    P001: { name: '熱切分條機 (E-17)', location: 'C棟1樓', category: '本業加工', status: 'running', communicationStatus: 'normal', points: [{ name: '切刀溫度', value: '185.0°C', unit: '°C', status: 'normal' },{ name: '切割速度', value: '45 m/min', unit: 'm/min', status: 'normal' },{ name: '張力', value: '22.8 N', unit: 'N', status: 'normal' },{ name: '刀壓', value: '4.5 bar', unit: 'bar', status: 'normal' },{ name: '電流', value: '38.4 A', unit: 'A', status: 'normal' }] },
    P002: { name: '裁切設備 (E-11)', location: 'C棟1樓', category: '本業加工', status: 'standby', communicationStatus: 'normal', points: [{ name: '刀具溫度', value: '28.2°C', unit: '°C', status: 'normal' },{ name: '裁切速度', value: '0 m/min', unit: 'm/min', status: 'normal' },{ name: '氣壓', value: '6.0 bar', unit: 'bar', status: 'normal' },{ name: '電流', value: '2.1 A', unit: 'A', status: 'normal' }] },
    P004: { name: '裁切設備 (E-12)', location: 'C棟1樓', category: '本業加工', status: 'running', communicationStatus: 'normal', points: [{ name: '刀具溫度', value: '29.5°C', unit: '°C', status: 'normal' },{ name: '裁切速度', value: '12 m/min', unit: 'm/min', status: 'normal' },{ name: '氣壓', value: '6.2 bar', unit: 'bar', status: 'normal' },{ name: '電流', value: '8.4 A', unit: 'A', status: 'normal' }] },
    ...
    CV001: { name: '分條機 (G-01)', location: 'D棟1樓', category: 'COVER加工', status: 'running', communicationStatus: 'normal', points: [{ name: '分條速度', value: '60 m/min', unit: 'm/min', status: 'normal' },{ name: '張力', value: '18.5 N', unit: 'N', status: 'normal' },{ name: '刀具溫度', value: '42.0°C', unit: '°C', status: 'normal' },{ name: '電流', value: '25.3 A', unit: 'A', status: 'normal' },{ name: '振動', value: '0.5 mm/s', unit: 'mm/s', status: 'normal' }] },
    CV005: { name: '分條機 (G-02)', location: 'D棟1樓', category: 'COVER加工', status: 'standby', communicationStatus: 'normal', points: [{ name: '分條速度', value: '0 m/min', unit: 'm/min', status: 'normal' },{ name: '張力', value: '0 N', unit: 'N', status: 'normal' },{ name: '刀具溫度', value: '25.0°C', unit: '°C', status: 'normal' },{ name: '電流', value: '1.2 A', unit: 'A', status: 'normal' },{ name: '振動', value: '0.0 mm/s', unit: 'mm/s', status: 'normal' }] },
    CV006: { name: '分條機 (G-03)', location: 'D棟1樓', category: 'COVER加工', status: 'running', communicationStatus: 'normal', points: [{ name: '分條速度', value: '58 m/min', unit: 'm/min', status: 'normal' },{ name: '張力', value: '17.8 N', unit: 'N', status: 'normal' },{ name: '刀具溫度', value: '40.5°C', unit: '°C', status: 'normal' },{ name: '電流', value: '24.1 A', unit: 'A', status: 'normal' },{ name: '振動', value: '0.4 mm/s', unit: 'mm/s', status: 'normal' }] },
    CV002: { name: '貼合機1', location: 'D棟1樓', category: 'COVER加工', status: 'standby', communicationStatus: 'normal', points: [{ name: '貼合壓力', value: '3.8 bar', unit: 'bar', status: 'normal' },{ name: '貼合速度', value: '0 m/min', unit: 'm/min', status: 'normal' },{ name: '溫度', value: '35.1°C', unit: '°C', status: 'normal' },{ name: '電流', value: '1.8 A', unit: 'A', status: 'normal' }] },
    CV007: { name: '貼合機2', location: 'D棟1樓', category: 'COVER加工', status: 'running', communicationStatus: 'normal', points: [{ name: '貼合壓力', value: '3.9 bar', unit: 'bar', status: 'normal' },{ name: '貼合速度', value: '15 m/min', unit: 'm/min', status: 'normal' },{ name: '溫度', value: '36.5°C', unit: '°C', status: 'normal' },{ name: '電流', value: '2.5 A', unit: 'A', status: 'normal' }] },
    ...
    AQ001: { name: '空氣品質1', location: 'F棟1樓', category: '廠務', status: 'running', communicationStatus: 'normal', points: [{ name: 'PM2.5', value: '12.4 μg/m³', unit: 'μg/m³', status: 'normal' },{ name: 'PM10', value: '28.7 μg/m³', unit: 'μg/m³', status: 'normal' },{ name: 'CO₂', value: '620 ppm', unit: 'ppm', status: 'normal' },{ name: 'TVOC', value: '0.18 mg/m³', unit: 'mg/m³', status: 'normal' },{ name: '溫度', value: '24.5°C', unit: '°C', status: 'normal' }] },
    AQ002: { name: '空氣品質2', location: 'F棟2樓', category: '廠務', status: 'running', communicationStatus: 'normal', points: [{ name: 'PM2.5', value: '15.1 μg/m³', unit: 'μg/m³', status: 'normal' },{ name: 'PM10', value: '31.3 μg/m³', unit: 'μg/m³', status: 'normal' },{ name: 'CO₂', value: '680 ppm', unit: 'ppm', status: 'normal' },{ name: 'TVOC', value: '0.22 mg/m³', unit: 'mg/m³', status: 'normal' },{ name: '溫度', value: '25.2°C', unit: '°C', status: 'normal' }] },
}
