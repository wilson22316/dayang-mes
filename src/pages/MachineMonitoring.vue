...
const machines = {
    ...
    coating: [
        { id: 'C001', name: '調膠溫度與啟動', location: 'B棟1樓', status: 'running', communicationStatus: 'normal' },
        { id: 'C002', name: '塗佈機', location: 'B棟1樓', status: 'standby', communicationStatus: 'normal' },
    ],
    processing: [
        { id: 'P001', name: '熱切分條機', location: 'C棟1樓', status: 'running', communicationStatus: 'normal' },
        { id: 'P002', name: '裁切設備', location: 'C棟1樓', status: 'standby', communicationStatus: 'normal' },
        { id: 'P003', name: '複捲設備', location: 'C棟2樓', status: 'stopped', communicationStatus: 'error' },
    ],
    cover: [
        { id: 'CV001', name: '分條機', location: 'D棟1樓', status: 'running', communicationStatus: 'normal' },
        { id: 'CV002', name: '貼合設備', location: 'D棟1樓', status: 'standby', communicationStatus: 'normal' },
        { id: 'CV003', name: 'AOI 檢出資料', location: 'D棟2樓', status: 'running', communicationStatus: 'normal' },
